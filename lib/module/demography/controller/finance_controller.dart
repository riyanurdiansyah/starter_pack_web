...
class FinanceController extends GetxController {
  ...
  RxList<double> priceSliders = <double>[].obs;
  ...
  Future getProducts() async {
    ...
    listHoveredProduct.value = List.generate(productsOwn.length, (i) => false);
    priceSliders.value =
        List.generate(productsOwn.length, (i) => productsOwn[i].minPrice);
  }
      ...
      "areas": demographys.map((e) {
        ...
        demographyJson["products"] = productsOwn.map((product) {
          ...
          return product
              .copyWith(
                  priceDistribute:
                      double.tryParse(priceSliders[index].toStringAsFixed(1)))
              .toJson();
        }).toList();
