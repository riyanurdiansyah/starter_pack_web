                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        Obx(() {
                          if (_c.isLoading.value || _c.sellings.isEmpty) {
                                                  ...
                                                  Obx(() {
                                                    if (_c.isDone.value) {
                                                      return Expanded(
                                                        child: AppTextNormal
                                                            .labelBold(
                                                          "Your stock in Area : ${_c.oldDistributions[0].areas[_c.oldDistributions[0].areas.indexWhere((e) => e.areaId == data.id)].products[_c.oldDistributions[0].areas[_c.oldDistributions[0].areas.indexWhere((e) => e.areaId == data.id)].products.indexWhere((e) => e.productId == prod.id)].qty - _c.oldDistributions[0].areas[_c.oldDistributions[0].areas.indexWhere((e) => e.areaId == data.id)].products[_c.oldDistributions[0].areas[_c.oldDistributions[0].areas.indexWhere((e) => e.areaId == data.id)].products.indexWhere((e) => e.productId == prod.id)].sold}",
                                                          16,
                                                          Colors.white,
                                                        ),
                                                      );
                                                                  ...
                                                                  onChanged:
                                                                    ...
                                                                    if (value
                                                                      ...
                                                                      if (typedValue <=
                                                                        ...
                                                                        _c.listDistribute[index]["products"][i] =
                                                                            typedValue;
                                                                      } else {
                                                                        // Jika melebihi batas, tetap gunakan nilai sebelumnya
                                                                        (_c.listDistribute[index]["controller"][i]
                                                                                as TextEditingController)
                                                                            .text = _c.listDistribute[index]["products"]
                                                                                [i]
                                                                            .toString();
                                                                        (_c.listDistribute[index]["controller"][i] as TextEditingController).selection =
                                                                            TextSelection.fromPosition(
                                                                          TextPosition(
                                                                              offset: (_c.listDistribute[index]["controller"][i] as TextEditingController).text.length),
                                                                        );
                                                                      }
                                                                    }
                                                                    _c.listDistribute[index]
                                                                    ...
                                                                    _c.listDistribute[
                                                                            index]
                                                                        [
                                                                        "total"] = double.parse((int.parse((_c.listDistribute[index]["controller"][i] as TextEditingController).text) *
                                                                            data
                                                                                .cost)
                                                                        .toStringAsFixed(
                                                                            2));
                                                              ...
                                                              Slider(
                                                                ...
                                                                onChanged:
                                                                  ...
                                                                  _c.listDistribute[
                                                                          index]
                                                                      [
                                                                      "total"] = double.parse((int.parse((_c.listDistribute[index]["controller"][i] as TextEditingController)
                                                                              .text) *
                                                                          data
                                                                              .cost)
                                                                      .toStringAsFixed(
